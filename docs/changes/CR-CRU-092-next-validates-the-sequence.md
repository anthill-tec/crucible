...
- **Design**: `.lavish/crucible-workflow-flowchart.html` §13 (also §7 conditional rule, §10 call chain + division of labour, §12 severities) · `docs/research/DN-crucible-roadmap-view.md`
