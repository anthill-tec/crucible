...
- [x] §S1.4: 5 unlinked runs render as one `ungrouped · 5 runs` row with NO run entries mounted; clicking expands the 5 entries; the count row never disappears (degradation preserved).
