...
| [CR-CRU-046](CR-CRU-046-toon-conformance.md) | TOON conformance: adopt `@toon-format/toon` server-side, conform `clients/toon.py` (list `- ` prefix + spec quoting); cross-stack round-trip gate | patch | PENDING (0.1.0 blocker) | 005, 030 | 4 |
