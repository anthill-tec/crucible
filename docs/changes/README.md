...
| [CR-CRU-056](CR-CRU-056-ambiguous-auto-attach-throws.md) | Agent registration binds its cycle EXPLICITLY (validated; TDD phases require it); server-side auto-attach guessing DELETED — the multi-track enabler | patch | PENDING (P0) | 036, 024, 044 | 4 |
