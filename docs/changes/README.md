...
| [CR-CRU-036](CR-CRU-036-patch-client-axi-transition-fixes.md) | Patch: client TOON-AXI transition fixes — §S9 server-active-cycle (remove WORKFLOW_CYCLE_ID, warn+withhold) + CR-008 TS test retarget + fleet coverage-uniformity | patch | PENDING (P1 — next; restores CR-008 suite to green) | 030 | 4 |
