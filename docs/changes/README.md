...
| [CR-CRU-015](CR-CRU-015-bdd-harness.md) | BDD harness: Playwright runner + codec + tab | feature | PENDING (post-0.2.0) | 004, 007 | 6 (post-0.2.0) |
| [CR-CRU-017](CR-CRU-017-run-lifecycle.md) | Run lifecycle: start/end + Aborted state | feature | COMPLETED (0.2.0) | 008, 011 | 5 (0.2.0) |
| [CR-CRU-018](CR-CRU-018-responsive-mobile.md) | Responsive: mobile + tablet media | feature | PENDING (post-0.2.0) | 016 | 6 (post-0.2.0) |
| [CR-CRU-022](CR-CRU-022-roadmap-analytics.md) | Roadmap analytics: velocity + burndown + forecast — **deferred past 0.2.0**; it owns the confidence-gated P50/P80 forecast, so the roadmap's "possible release date" reading (CR-078 §S2) lands with THIS CR, not in 0.2.0 | feature | PENDING (post-0.2.0) | 011, 014 | 6 (post-0.2.0) |
