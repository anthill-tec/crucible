...
| [CR-CRU-060](CR-CRU-060-e2e-harness-identity-drift.md) | The e2e harness predates the registered-caller hard stop — `filePlan` sends no `agentId`, ingest helpers send unregistered ones; 19 scenarios fail. Server is CORRECT, harness is stale. Re-baselines the release gate | patch | PENDING | 056, 052 | 4 |
