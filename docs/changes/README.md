...
| [CR-CRU-059](CR-CRU-059-identity-source-validation.md) | Server does not validate `identity.source` — the clients' documented enum `{claude-md,package-json,git-repo,manual}` is unenforced (rust/mvn/arduino shipped `openclaw` undetected); validate at the route boundary like `phase` | patch | PENDING | 044, 054 | 4 |
