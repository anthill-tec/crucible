...
| [CR-CRU-118](CR-CRU-118-every-cr-names-a-release.md) | every live CR names a release, and every release names its target date | feature | PENDING (0.2.0) | 091, 099, 104 | 6 (0.2.0) |
