...
| [CR-CRU-056](CR-CRU-056-ambiguous-auto-attach-throws.md) | Patch: ambiguous active-cycle auto-attach must THROW (409 + cycle enumeration + help), never silently pick — every auto-attach consumer | patch | PENDING | 036, 024 | 4 |
